...
namespace WebDav
{
    ...
    public class WebDavManager
    {
        ...
        /// </summary>
        public WebDavManager(string strUser, string strPassword)
        {
            this.strUser = strUser;
            this.strPassword = strPassword;

            client = new WebClient.WebClient(strUser, strPassword);
        }
        ...
        public WebDavManager(WebDavCredential credential, string strUser, string strPassword)
        {
            this.strUser = strUser;
            this.strPassword = strPassword;
        ...
        public bool Delete(Uri uri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse @'Delete'" + Environment.NewLine + uri);
        ...
        public bool CreateDirectory(Uri uri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse @'CreateDirectory'" + Environment.NewLine + uri);
        ...
        public bool Copy(Uri sourceUri, Uri targetUri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse @'Copy'" + Environment.NewLine + sourceUri);
        ...
        public bool Move(Uri sourceUri, Uri targetUri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse @'Move'" + Environment.NewLine + sourceUri);
        ...
        public bool Exists(Uri uri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse @'Exists'" + Environment.NewLine + uri);
        ...
        public List<WebDavResource> List(Uri uri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse @'List'" + Environment.NewLine + uri);
        ...
        {
            //uri = new Uri ("http://192.168.205.238/owncloud/remote.php/dav/files/Administrator/");
        ...
        /// <param name="uri">The Uri.</param>
		/// <returns>File contents.</returns>
        public MemoryStream DownloadFile(Uri uri)
        {
            ...
            {
                // TODO: Errorhandling
                Function.showMessage("Empty WebResponse " + Environment.NewLine + uri + Environment.NewLine);
