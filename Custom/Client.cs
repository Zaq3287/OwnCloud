...
namespace Custom
{
    public class Client
    {
        ...
        //private const string ocspath = "/ocs/v1.php/apps/files_sharing/api/v1/shares";
        ...
        public Client(string url, string user_id, string password)
        {
            ...
            this.url = url;
            this.strUser = user_id;
            this.strPassword = password;

            //Global.strDavUrl = url;
            ...
            this.dav = new WebDavManager(user_id, password);
            // Configure WebDavNet for BasicAuth
            this.dav.Credential = new WebDavCredential(user_id, password);
            this.dav.Credential.AuthenticationType = AuthType.Digest;
        }
        #endregion
        ...
        {
            var client = new WebClient.WebClient(strUser, strPassword);
